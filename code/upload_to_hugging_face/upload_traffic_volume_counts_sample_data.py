...
api = HfApi(token="<hf_your_actual_token_here>") # Contact OSCUR members or Sonia Castelo (scq202@nyu.edu) to get the token
local_dataset_path = "./traffic_volume_counts_sample_data"  # Path to folder with your dataset
csv_filename = "sample_traffic.csv"  # Your CSV file
repo_id = "oscur/automated-traffic-volume-counts-sample"  # Hugging Face dataset repo ID
dataset_title = "Automated Traffic Volume Counts (Small sample)"  # For README title
dataset_description = "This dataset contains a sample for traffic volume counts captured automatically."  # For README
